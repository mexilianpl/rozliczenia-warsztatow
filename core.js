...
let data=JSON.parse(localStorage.getItem("rw45")||"null")||{
 children:[
 {id:1,last:"Wiśniewska",first:"Anna",sex:"Dziewczynka",class:"4A",school:"SP 162",club:"Tak",parent:"Piotr Wiśniewski",phone:"",email:"",classes:[
...
function girlWord(n){return polishCount(n,"dziewczynka","dziewczynki","dziewczynek")}
function boyWord(n){return polishCount(n,"chłopiec","chłopcy","chłopców")}
